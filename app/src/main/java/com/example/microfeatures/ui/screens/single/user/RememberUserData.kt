 ...
 */
package com.example.microfeatures.ui.screens.single.user
...
@Composable
internal fun rememberUserDataState(): State<UserModel> {
    val viewModel: SingleViewModelViewModel = hiltViewModel()

    return viewModel.userState.collectAsStateWithLifecycle()
}